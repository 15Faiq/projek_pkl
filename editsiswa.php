                        ...
                        <form action="updatesiswa.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="perbarui"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;Save</button>
                                        </div>
                                    </div>
                                </div>
