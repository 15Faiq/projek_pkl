...
while ($row = mysqli_fetch_array($result)) {
  ...
  $sub_array[] = '<center><a href="editsiswa.php?id=' . $row['no_id'] . '" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
 <a href="bayarspp.php?id=' . $row['no_id'] . ' </a>
 </center>';
  $data[] = $sub_array;

function delete_data($id) {
  $where = array('no_id' => $id);
  $this->ModelPenggajian->delete_data($where, 'data_siswa');
