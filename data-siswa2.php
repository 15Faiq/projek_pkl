...
<body>
      ...
      <div class="card-body">
        <div class="table-wrapper">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="staticBackdropLabel">Import Data Hero</h5>
                ...
                <div class="modal-footer">
                  <a href="code crud/data_siswa2.csv" class="btn btn-success" download="data-siswa2.csv">Download Csv</a>
          ...
          <div class="table-responsive mt-2">
            <table id="data_siswa2" class="table table-bordered table-hover" style="border-radius: 5px; font-size : 14px; width: 100%;">
              <thead>
                <tr style="text-align: center; height : 25px;">
                  ...
                  <th scope="col">SF</th>
                  <th scope="col">Rata-rata sales</th>
                  <th scope="col">Rata-rata revenue</th>
                  <th scope="col">LIS</th>
                  <th scope="col">Pelanggan 2P </th>
                  <th scope="col">Pelanggan 3P </th>
                  <th scope="col">Alpro</th>
  ...
  <script type="text/javascript" language="javascript">
    $(document).ready(function() {
      var dataTable = $('#data_siswa2').DataTable({
        "processing": true,
        "serverSide": true,
        "order": [],
        "ajax": {
          url: "code crud/table-siswa2.php",
          type: "POST",
        }
      });
