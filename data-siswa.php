    ...
    <div class="card" style="margin-left:auto;margin-right:auto;border-color: #fff;">
      <div class="card-body">
        <div class="table-wrapper">
          <h3 class="card-title">Data Datel</h3>
          <table>
            <tr>
            <td><a href="input-siswa" class="btn btn-success btn-sm"><i class="fas fa-file-import"></i> Add Data</a></td>
